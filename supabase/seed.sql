...
INSERT INTO courses (course_id, template_id, course_name, course_date, course_coordinator)
VALUES (
...
VALUES
  ('00000000-0000-0000-0000-000000000031', '00000000-0000-0000-0000-000000000021',
   'Alex Thompson', 'P123456', 'Registered Nurse', 'Emergency Department', 'BOTH'),
  ('00000000-0000-0000-0000-000000000032', '00000000-0000-0000-0000-000000000021',
   'Jordan Lee', 'P234567', 'Clinical Nurse', 'Intensive Care Unit', 'TEAM_MEMBER'),
  ('00000000-0000-0000-0000-000000000033', '00000000-0000-0000-0000-000000000021',
   'Casey Martinez', 'P345678', 'Medical Officer', 'Emergency Department', 'BOTH')
